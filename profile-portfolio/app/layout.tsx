...
const personSchema = {
  ...
  description:
    "Computer Science undergraduate at Universitas Negeri Semarang and McKinsey Forward Program Participant with strong capabilities in software engineering, applied AI, and project leadership.",
  url: "https://imanyunar.my.id",
  image: "https://imanyunar.my.id/profile.png",
  email: "imanyunar@gmail.com",
  telephone: "+6285172247452",
  sameAs: [
  ...
  knowsAbout: [
    ...
    "Structured Problem Solving (MECE Framework)",
  ...
  hasCredential: [
    {
      ...
      name: "Bachelor of Computer Science (In Progress)",
      recognizedBy: {
        "@type": "CollegeOrUniversity",
        name: "Universitas Negeri Semarang",
      },
      description: "GPA: 3.84 out of 4.00",
    },
  ],
  workLocation: {
    "@type": "Place",
